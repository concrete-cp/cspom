...
public class ProblemTest {
    ...
    public void testSemiCompilePredicates() throws ScriptException,
        ...
        final Problem problem = Problem.load(this.getClass().getResource(
                "cc-6-6-2.xml.bz2"));
        ...
        final Variable var0 = constraint.getScope()[0];
        final Variable var1 = constraint.getScope()[1];
        final Variable var2 = constraint.getScope()[2];
        final Variable var3 = constraint.getScope()[3];
