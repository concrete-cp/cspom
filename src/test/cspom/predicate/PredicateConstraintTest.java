...
public class PredicateConstraintTest {
	...
	public void setUp() throws Exception {
		...
		constraint = new PredicateConstraint("c1", Arrays
				.asList(new Variable[] { var1, var2 }), "v1 v2", predicate);
	...
	public void testStandardize() throws ScriptException {
		PredicateConstraint c2 = constraint.standardize(Arrays
				.asList(new Variable[] { var2, var1 }));
