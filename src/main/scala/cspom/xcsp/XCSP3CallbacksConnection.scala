...
trait XCSP3CallbacksConnection extends XCSP3CallbacksVars {
  ...
  private def buildCtrMember(value: SimpleExpression[Int], list: CSPOMSeq[Int]): CSPOMConstraint[Boolean] = {
    cspom.ctr {
  ...
  private def buildCtrElement(value: SimpleExpression[Int], index: SimpleExpression[Int], list: CSPOMSeq[Int]) = {
    cspom.ctr {
