...
public class ExtensionConstraint extends AbstractConstraint {
    ...
    public ExtensionConstraint(final String name,
            final Extension relation, final Variable... scope) {
        super(name, scope);
    ...
    public ExtensionConstraint standardize(final Variable[] scope) {
        ...
        return new ExtensionConstraint(getName(), relation
                .reverse(newPosition), scope);
    }
