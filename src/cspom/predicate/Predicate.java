...
public class Predicate extends AbstractRelation {
	...
	private final static Compilable engine;
	...
	public boolean evaluate(final Map<String, ? extends Number> values)
			throws ScriptException {
	...
	private final static String transform(final String expr) {
